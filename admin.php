  ...
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          ...
          <hr>
          <p class="lead font-weight-bold">Silahkan Pesan Tiket Hnya di Only Bus Sesuai Keinginan Anda <br> 
  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">#pastiontimepakeOnlyBus</h3>
        </div>

        <div class="row mb-5 mt-5 ">
          <div class="col-md-6 d-flex justify-content-end">
            <div class="card bg-dark text-white border-light">
              <img src="images/background/menu2.png" class="card-img" alt="Lihat Daftar TIKET">
              <div class="card-img-overlay mt-5 text-center">
               <a href="daftar_tiket.php" class="btn btn-primary">LIHAT DAFTAR TIKET</a>
              </div>
            </div>
          </div>
